...
$ExpectedOffice = '2.0.2-JEV-FULL-CORTEX-R2534'
$Work = Join-Path $InstallRoot 'R2534-JEV-FULL-CORTEX'
...
Write-Host 'R2534_PRECHECK_LIVE_OFF'
...
if ([string]$health.jevSovereign.experienceMemory -ne 'ALWAYS_ON_MEASURED_OUTCOMES_PLUS_JEV_LESSONS') { throw 'Experience Memory metadata missing.' }
...
Write-Host 'R2534_PC_UPDATE_OK'
Write-Host 'R2534_OFFICE_UPDATE_OK'
Write-Host 'R2534_CORTEX_DOC_OK'
Write-Host 'R2534_CORTEX_RUNTIME_LOADED_OK'
Write-Host 'R2534_EXPERIENCE_MEMORY_OK'
Write-Host 'R2534_LIVE_VERIFIED_OFF'
