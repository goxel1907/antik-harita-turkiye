...
$plan=$probe.plan
$summary=@()
$summary += "JEV VISION AUDIT R2540"
...
$summary += "Annotated PNG draws candles, volume, EMA20/EMA50, trend guide, dealing-range HIGH/LOW/EQ with premium/discount, prior20/equal liquidity, FVG/CE50, bullish/bearish OB, OTE, Fib retracement, swing/BOS/CHoCH reference levels and observed Binance force-order liquidation zones when available."
$summary += ""
$summary += "VISION TEXT:"
