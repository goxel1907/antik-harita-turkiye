...
$ExpectedOffice = '2.0.4-JEV-RESILIENT-R2536'
...
$Work = Join-Path $InstallRoot 'R2536-JEV-RESILIENT'
...
Write-Host 'R2536_PRECHECK_LIVE_OFF'
...
Write-Host 'R2536_PC_UPDATE_OK'
Write-Host 'R2536_OFFICE_UPDATE_OK'
Write-Host 'R2536_CORTEX_RUNTIME_LOADED_OK'
Write-Host 'R2536_MEMORY_LIFETIME_OK'
Write-Host 'R2536_LIFETIME_MEMORY_OK'
Write-Host 'R2536_RESEARCH_DESK_OK'
...
Write-Host 'R2536_LIVE_VERIFIED_OFF'
