...
test('R2535 JEV-directed research runs after evidence collection and before PASS-2',()=>{
  ...
  assert.match(flow,/pass1\.knowledgeResearchRequested===true/);
  assert.match(flow,/familyHint:pass1\.knowledgeFamily/);
});
