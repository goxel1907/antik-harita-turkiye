...
$Branch = 'r2542-jev-trader-office-pc'
...
$Work = Join-Path $InstallRoot 'R2542-JEV-TRADER-OFFICE'
...
Write-Host 'R2542_SOURCE_REGRESSION_OK'
...
Write-Host 'R2542_PC_UPDATE_OK'
Write-Host 'R2542_JEV_TRADER_OFFICE_OK'
