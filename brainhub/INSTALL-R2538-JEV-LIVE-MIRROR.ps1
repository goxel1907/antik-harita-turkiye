...
$Work = Join-Path $InstallRoot 'R2538-JEV-LIVE-MIRROR'
...
Write-Host 'R2538_PRECHECK_LIVE_OFF'
...
Write-Host 'R2538_PC_UPDATE_OK'
Write-Host 'R2538_OFFICE_UPDATE_OK'
Write-Host 'R2538_CORTEX_RUNTIME_LOADED_OK'
Write-Host 'R2538_MEMORY_LIFETIME_OK'
Write-Host 'R2538_LIFETIME_MEMORY_OK'
Write-Host 'R2538_RESEARCH_DESK_OK'
Write-Host 'R2538_RESEARCH_RETRY_OK'
Write-Host 'R2538_OSS_REFERENCE_OK'
Write-Host 'R2538_VISION_SCHEMA_REPAIR_OK'
Write-Host 'R2538_VISION_EVIDENCE_ONLY_OK'
...
Write-Host 'R2538_VISION_SMC_OVERLAYS_OK'
Write-Host 'R2538_FREE_RESEARCH_OK'
Write-Host 'R2538_EXIT_BINDING_OK'
Write-Host 'R2538_PARTIAL_BINDING_OK'
Write-Host 'R2538_LIVE_VERIFIED_OFF'
