...
const server=http.createServer(async(req,res)=>{
  try{
    ...
    if(req.method==='GET'&&u.pathname==='/live/status'){
      return send(res,200,{...live.status(),featureVersion:'9.5.104-VISION',sizingAuthority:'USER_PANEL_EXACT',visionAvailability:visionAvailability(),visionProgress:{...localVisionProgress,queueDepth:localVisionQueueDepth,pipelineActive:decisionPipelineActive},jev:jev.localStatus(),openRouterBilling:jev.billingSnapshot()});
    }
