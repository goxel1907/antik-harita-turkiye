...
function Test-Brain([string]$BrainRoot, [switch]$IncludeDeep) {
    ...
    if ($null -eq $planWorkerStatus -or -not [bool](Get-PropValue $planWorkerStatus 'enabled' $false) -or [string](Get-PropValue $planWorkerStatus 'routineRouter' '') -ne '9ROUTER_FREE_TEXT') {
