...
function Test-Brain([string]$BrainRoot, [switch]$IncludeDeep) {
    ...
    if ([string]$h.featureVersion -ne '9.5.109-CLAUDE-VISION') { throw "Beklenen PC Brain Hub surumu 9.5.109-CLAUDE-VISION; gelen=$($h.featureVersion)" }
