...
$ExpectedOffice = '2.0.6-JEV-LIVE-MIRROR-R2538'
...
$Work = Join-Path $InstallRoot 'R2539-ANDROID-PC-ONLY-SAFETY'
...
Write-Host 'R2539_PRECHECK_LIVE_OFF'
...
if (-not ($health.features -contains 'JEV_LIVE_MIRROR_READ_ONLY')) { throw 'R2538 live mirror marker missing.' }
if (-not ($health.features -contains 'JEV_MIRROR_PACKET_CHART_PARITY')) { throw 'R2538 packet/chart parity marker missing.' }
...
if ([string]$health.jevSovereign.liveMirror.version -ne 'R2.5.3.8') { throw 'R2538 live mirror metadata missing.' }
...
Write-Host 'R2539_PC_UPDATE_OK'
Write-Host 'R2539_OFFICE_UPDATE_OK'
Write-Host 'R2539_CORTEX_RUNTIME_LOADED_OK'
Write-Host 'R2539_MEMORY_LIFETIME_OK'
Write-Host 'R2539_LIFETIME_MEMORY_OK'
Write-Host 'R2539_RESEARCH_DESK_OK'
Write-Host 'R2539_RESEARCH_RETRY_OK'
Write-Host 'R2539_OSS_REFERENCE_OK'
Write-Host 'R2539_VISION_SCHEMA_REPAIR_OK'
Write-Host 'R2539_VISION_EVIDENCE_ONLY_OK'
Write-Host 'R2539_VISION_AUDIT_TOOL_OK'
Write-Host 'R2539_CONTEXT_COMPLETE_OK'
Write-Host 'R2539_JEV_LIVE_MIRROR_OK'
Write-Host 'R2539_REMOTE_EXECUTE_BLOCK_OK'
if ([int]$mirror.parity.mismatches -eq 0) {
  Write-Host 'R2539_PACKET_CHART_PARITY_OK'
} else {
  Write-Host ("R2539_PACKET_CHART_PARITY_VISIBLE mismatches={0}" -f $mirror.parity.mismatches)
}
Write-Host 'R2539_OFFICE_MIRROR_CARD_OK'
Write-Host 'R2539_SETUP_TAXONOMY_OK'
Write-Host 'R2539_ENTRY_TIMING_OK'
Write-Host 'R2539_VISION_SMC_OVERLAYS_OK'
Write-Host 'R2539_FREE_RESEARCH_OK'
Write-Host 'R2539_EXIT_BINDING_OK'
Write-Host 'R2539_PARTIAL_BINDING_OK'
Write-Host 'R2539_LIVE_VERIFIED_OFF'
